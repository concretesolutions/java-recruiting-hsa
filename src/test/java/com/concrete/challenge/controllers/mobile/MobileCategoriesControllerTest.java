...
public class MobileCategoriesControllerTest {

    @InjectMocks
    private MobileCategoriesController mobileCategoriesController;
    ...
    public void topFiveZeroCategoriesTest() {
        ...
        when(categoriesService.getMobileTopCategories(relevantCategories)).thenReturn(categories);

        ResponseEntity<List<Category>> result = mobileCategoriesController.getTopCategories(relevantCategories);
    ...
    public void afterTopFiveZeroCategoriesTest() {
        ...
        when(categoriesService.getMobileTopCategoriesAfterTop(relevantCategories)).thenReturn(categories);

        ResponseEntity<List<Category>> result = mobileCategoriesController.getCategoriesAfterTop(relevantCategories);
        assertEquals("The HttpStatus should be 204", HttpStatus.NO_CONTENT, result.getStatusCode());
    }
