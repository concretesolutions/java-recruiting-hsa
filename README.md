...
Métodos de consulta:
getCategoriesTopFive: http://localhost:8091/java-recruiting-hsa/v1/categories/topFive
getRestOfCategories: http://localhost:8091/java-recruiting-hsa/v1/categories/rest
getNotExpiredCoupons: http://localhost:8091/java-recruiting-hsa/v1/coupons
